...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/guestlectures.css">
	<link rel="shortcut icon" type="image/x-icon" href="../assets/cz_logo.ico" />
</head>
<body>
	<video autoplay muted loop id="BreakingBadBG">
		<source src="../assets/BreakingBadBG.mp4" type="video/mp4">
	</video>
	<div class="container" style="height: 100%;">
		<div class="row mt-5 ">
			<div class="col-12 d-flex justify-content-center">
				<img src="../assets/breakingbad_h.png" class="img-fluid breakingbad_h">
			</div>
		</div>
		<div id="guest-container">
			<div class="row justify-content-between mt-5">
				<div id="guest_1" class="col-md-3 col-sm-11 col-xs-11 col-11 guest-card">
					<div class="text-center overlay">
						<h1>guest lecture</h1>
					</div>
				</div>
				<div id="guest_2" class="col-md-3 col-sm-11 col-xs-11 col-11 guest-card">
					<div class="text-center overlay">
						<h1>guest lecture</h1>
					</div>
				</div>
				<div id="guest_3" class="col-md-3 col-sm-11 col-xs-11 col-11 guest-card">
					<div class="text-center overlay">
						<h1>guest lecture</h1>
					</div>
				</div>								
		...
		<div id="guest_m_1" class="modal">
			<div class="modal-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<span class="pull-right"><a href="#" class="close"></a></span>
							<h1 class="text-center">Workshop-1</h1>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
		...
		<div id="guest_m_2" class="modal">
			<div class="modal-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<span class="pull-right"><a href="#" class="close"></a></span>
							<h1 class="text-center">Workshop-2</h1>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
		...
		<div id="guest_m_3" class="modal">
			<div class="modal-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<span class="pull-right"><a href="#" class="close"></a></span>
							<h1 class="text-center">Workshop-3</h1>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
	...
	<script type="text/javascript" src="../js/guestlectures.js"></script>
</body>
</html>